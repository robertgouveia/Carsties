        ...
        <form className="flex flex-col mt-3" onSubmit={handleSubmit(onSubmit)}>
            ...
            {pathname === "/auctions/create" && (
                <>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <Input label="Reserve Price" name="reservePrice" type="number" control={control} rules={{required: "Reserve Price is required"}}/>
                        <DateInput label="Auction End" name="auctionEnd" control={control} rules={{required: "Auction End is required"}} dateFormat="dd MMMM yyyy h:mm: a" showTimeSelect/>
                    </div>
                </>
            )}
